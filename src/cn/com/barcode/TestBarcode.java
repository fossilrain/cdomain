...
public class TestBarcode {
    ...
    public static String createBarCode1(String savePath, String jbarCode,
            String imgFormat) {
        ...
        try {
            ...
            // 实例化JBarcode
            // 这里三个参数，必要填写
            JBarcode jbarcode13 = new JBarcode(Code128Encoder.getInstance(),
                    WidthCodedPainter.getInstance(),
                    EAN13TextPainter.getInstance());
            ...
            // 尺寸，面积，大小
            jbarcode13.setXDimension(Double.valueOf(0.5).doubleValue());
            // 条形码高度
            jbarcode13.setBarHeight(Double.valueOf(30).doubleValue());
            // 宽度率
            jbarcode13.setWideRatio(Double.valueOf(30).doubleValue());
            // 是否校验最后一位，默认是false
//            jbarcode13.setShowCheckDigit(true);
//            是否显示字体
            jbarcode13.setShowText(true);
//         	   显示字体样式
            jbarcode13.setTextPainter(BaseLineTextPainter.getInstance()); 
            // 生成二维码
    ...
    public static void main(String[] args) throws InvalidAtributeException {
        ...
        String path = TestBarcode.createBarCode1("D://test//", "201709212200438426",
                ImageUtil.JPEG);
