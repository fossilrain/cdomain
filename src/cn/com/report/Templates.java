...
public class Templates {
	...
	static {
		rootStyle           = stl.style().setPadding(2).setFontName("ZWJT_FSZWJT_FS");
		...
		dynamicReportsComponent =
		  cmp.horizontalList(
//			cmp.image("http://127.0.0.1:8280/cdomain/barcode?id=201709212200438001").setFixedDimension(155, 60),
