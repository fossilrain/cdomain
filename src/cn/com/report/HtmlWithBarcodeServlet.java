 ...
 */
@WebServlet("/htmlWithBarcodeServlet")
public class HtmlWithBarcodeServlet extends HttpServlet {
	...
	try {
		...
		.setTemplate(template())
		  ...
		  .title(//shows report title
		  	cmp.horizontalList()
		  		.add(
//		  			barcode("Code128", bcode.code128("201709212200438426")),
		  			cmp.image(img).setFixedDimension(155, 60),
