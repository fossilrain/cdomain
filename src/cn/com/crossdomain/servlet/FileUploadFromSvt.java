...
/**
 * Servlet implementation class FileUploadFromSvt
 */
@WebServlet(description = "文件上传（从servlset）", urlPatterns = { "/FileUploadFromSvt" })
public class FileUploadFromSvt extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FileUploadFromSvt() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(request.getParameter("namex"));
